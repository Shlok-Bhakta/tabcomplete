"""Bounded LFM tokenizer compatibility retry after pinned conversion failure."""
...
OUT = Path("/kaggle/working/small_model_prototype_r1_lfm_conversion")
...
def main():
    ...
    run([sys.executable, "-m", "pip", "install", "-q", "numpy~=2.2.6",
         "sentencepiece>=0.1.98,<0.3.0", "transformers==5.17.0", "safetensors",
